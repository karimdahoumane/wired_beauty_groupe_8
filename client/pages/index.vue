<template>
    <v-container fluid class="pa-0">
        ...
        <v-container fluid class="pt-8 bg-white" data-aos="fade-right" data-aos-duration="2000">
            <v-row no-gutters justify="center" align="center">
                <v-col cols="8">
                    <h2 class="text-h2 text-center mb-16">BeautyTech X Skincare</h2>
                    <div style="position: relative; height: 600px">
                        <img style="height: 300px" :src="require(`~/assets/images/microscope.jpg`)" />
        ...
        <v-container fluid class="pt-8 bg-white" data-aos="fade-left" data-aos-duration="2000">
            <v-row no-gutters justify="center" align="center">
                <v-col cols="8">
                    <div style="position: relative; height: 600px">
                        ...
                        <v-row no-gutters justify="end">
                            <img style="height: 300px; right: 300px" :src="require(`~/assets/images/microscope.jpg`)" />
                        </v-row>
                    </div>
                </v-col>
            </v-row>
        </v-container>
        <v-container fluid class="pt-8 bg-white" data-aos="fade-up" data-aos-duration="2000">
            <v-row no-gutters justify="center" align="center">
                <v-col cols="8">
                    <div style="position: relative; height: 600px">
                        <div class="custom-block-one">
                            <v-row no-gutters justify="center" align="center">
                                <v-col cols="8">
                                    ...
                                    <ul>
                                        <li>The antioxydative and moisterizing effect of formulae (in vivo)</li>
                                        <li>The antioxydative and moisterizing effect of ingredients (in vitro) ➢ see REACH</li>
                                        <li>The consumer feedback after product use</li>
                                        <li>The environmental conditions (UV pollution) surronding the consumer’s lifestyle</li>
                                        <li>The skincare performance after 1 day – 8 days – 15 days - X days.</li>
                                    </ul>
                                </v-col>
                            </v-row>
                        </div>
...
import { TweenLite, Circ } from 'gsap/dist/gsap';
...
export default {
    ...
    mixins: [aosMixin],
    mounted() {
        gsap.registerPlugin(TweenLite, Circ);
        (function () {
            let width;
            let height;
            let largeHeader;
            ...
            function initHeader() {
                ...
                for (const i in points) {
                    const c = new Circle(points[i], 2 + Math.random() * 2, 'rgba(255,255,255,0)');
                    points[i].circle = c;
                }
            }
...
.custom-block-one {
    position: absolute;
    background-color: rgba(222, 161, 72, 0.42);
    z-index: 2;
    top: -10%;
    left: 40%;
    padding-top: 10px;
